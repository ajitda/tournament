...
if(props.tournaments){
  tableValue = props.tournaments.map(tournament =>(
    <tr>
      ...
      <td>
        {moment(tournament.start_time).format("HH:mm:ss")}
      </td>
      <td>
        ${tournament.teams}
      </td>
      <td>
          {/* <img className="mr-2" src="https://img.icons8.com/ios/24/000000/add-user-male.png" alt=""/> */}
          <img alt="" className="mr-2" src="https://img.icons8.com/material-outlined/24/000000/edit--v1.png" onClick={()=>goToEdit(tournament)}/>
          <img src="https://img.icons8.com/material-outlined/24/000000/add-trash.png" onClick={()=>deleteTournament(tournament)} alt=""/>
        </td>
    </tr>
